...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    World\x12[\n\x08SayHello\x12&.oak.examples.hello_world.HelloRequest\x1a'\
    .oak.examples.hello_world.HelloResponse\x12b\n\rLotsOfReplies\x12&.oak.e\
    xamples.hello_world.HelloRequest\x1a'.oak.examples.hello_world.HelloResp\
    onse0\x01\x12d\n\x0fLotsOfGreetings\x12&.oak.examples.hello_world.HelloR\
    equest\x1a'.oak.examples.hello_world.HelloResponse(\x01\x12`\n\tBidiHell\
    o\x12&.oak.examples.hello_world.HelloRequest\x1a'.oak.examples.hello_wor\
    ld.HelloResponse(\x010\x01b\x06proto3\
";
