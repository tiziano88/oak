...
pub fn compile_rust_wasm(cargo_path: &str, module_file_name: &str) -> anyhow::Result<Vec<u8>> {
...
pub fn run_single_module_with_config(
    ...
    let combined_config = runtime_config(module_file_name, entrypoint_name, config_map);
    oak_runtime::configure_and_run(combined_config)
}
...
pub fn runtime_config(
    ...
    let wasm: HashMap<String, Vec<u8>> = [(
        ...
        compile_rust_wasm(DEFAULT_MODULE_MANIFEST, module_file_name)
